...
async function main() {
  ...
  /* ============================================================================
     ...
     Example: 24COBEA160 = 2024, Computer Engineering, Serial 160
     ============================================================================ */
  console.log("📚 Creating faculty numbers...");
  await prisma.facultyNumber.createMany({
    data: [
      // Computer Engineering - 2024
      { faculty_no: "24COBEA160", admission_year: 2024, branch_code: "COBEA", branch_name: "Computer Engineering", roll_number: "160", program_type: "B.Tech" },
      { faculty_no: "24COBEA161", admission_year: 2024, branch_code: "COBEA", branch_name: "Computer Engineering", roll_number: "161", program_type: "B.Tech" },
      // Electronics Engineering - 2023
      { faculty_no: "23ELBEA168", admission_year: 2023, branch_code: "ELBEA", branch_name: "Electronics Engineering", roll_number: "168", program_type: "B.Tech" },
      // Electrical Engineering - 2023
      { faculty_no: "23EEBEA803", admission_year: 2023, branch_code: "EEBEA", branch_name: "Electrical Engineering", roll_number: "803", program_type: "B.Tech" },
      // Computer Engineering - 2022
      { faculty_no: "22COBEA205", admission_year: 2022, branch_code: "COBEA", branch_name: "Computer Engineering", roll_number: "205", program_type: "B.Tech" },
    ],
    skipDuplicates: true,
  });
  ...
  /* ============================================================================
     STUDENTS
     - Enrollment No: gq5012 (unique, never changes)
     - Email: gq5012@myamu.ac.in
     - Faculty No: 24COBEA160 (can change if branch changes)
  ...
  await prisma.student.createMany({
    data: [
      // INACTIVE STUDENTS (not registered yet) - Semester 1, CPI 0
      { enrollment_no: "gq5012", faculty_no: "24COBEA160", name: "Rahul Kumar", email: "gq5012@myamu.ac.in", password_hash: "", current_semester: 1, current_cpi: 0.0, is_active: false },
      { enrollment_no: "gp1212", faculty_no: "24COBEA161", name: "Priya Sharma", email: "gp1212@myamu.ac.in", password_hash: "", current_semester: 1, current_cpi: 0.0, is_active: false },
      
      // ACTIVE STUDENTS (registered)
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", name: "Mohit Verma", email: "gm7605@myamu.ac.in", password_hash: studentPassword, current_semester: 3, current_cpi: 8.0, is_active: true },
      { enrollment_no: "gs3456", faculty_no: "23EEBEA803", name: "Sneha Gupta", email: "gs3456@myamu.ac.in", password_hash: studentPassword, current_semester: 4, current_cpi: 9.0, is_active: true },
      { enrollment_no: "gt7890", faculty_no: "22COBEA205", name: "Tanvi Patel", email: "gt7890@myamu.ac.in", password_hash: studentPassword, current_semester: 6, current_cpi: 9.9, is_active: true },
    ],
    skipDuplicates: true,
  });
  ...
  await prisma.registrationRule.createMany({
    data: [
      { rule_name: "MAX_CREDITS", rule_type: "credit_limit", rule_value: "24", is_active: true },
  ...
  // STUDENT 1: gm7605 (Semester 3, CPI 8.0) - 2 semesters of history
  await prisma.gradeRecord.createMany({
    data: [
      // Semester 1 (Fall 2023)
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "AMS1121", grade: "B+", grade_points: 8.0, academic_year: 2023, semester_type: 1, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "APS1111", grade: "A", grade_points: 9.0, academic_year: 2023, semester_type: 1, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "APS1911", grade: "B+", grade_points: 8.0, academic_year: 2023, semester_type: 1, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "EZH1111", grade: "B", grade_points: 7.0, academic_year: 2023, semester_type: 1, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "MEA1121", grade: "B+", grade_points: 8.0, academic_year: 2023, semester_type: 1, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "COA1112", grade: "A", grade_points: 9.0, academic_year: 2023, semester_type: 1, is_backlog: false, is_improvement: false },
      
      // Semester 2 (Spring 2024)
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "AMS1122", grade: "B+", grade_points: 8.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "APS1112", grade: "B", grade_points: 7.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "APS1912", grade: "B+", grade_points: 8.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "ELA1112", grade: "A", grade_points: 9.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "EZH1112", grade: "B+", grade_points: 8.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "EZH1912", grade: "B", grade_points: 7.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
      { enrollment_no: "gm7605", faculty_no: "23ELBEA168", course_code: "MEA1122", grade: "B+", grade_points: 8.0, academic_year: 2024, semester_type: 2, is_backlog: false, is_improvement: false },
    ],
    skipDuplicates: true,
  });
  ...
  console.log("\n   🎓 Students (Active):");
  console.log("      • gm7605@myamu.ac.in / Student@123 (Semester 3, CPI 8.0)");
