 ...
 */
async function checkPrerequisites(enrollmentNo, courseCode) {
    try {
        ...
        for (const prereq of prerequisites) {
            ...
            const gradeMet = checkGradeRequirement(gradeRecord.grade || "", prereq.min_grade);
            if (!gradeMet) {
                missing.push({
                    course_code: prereq.prerequisite_course_code,
                    course_name: prereq.prerequisite.course_name,
 ...
 */
function checkGradeRequirement(actualGrade, minGrade) {
