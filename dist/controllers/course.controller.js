...
const prerequisite_service_1 = require("../services/prerequisite.service");
const credit_service_1 = require("../services/credit.service");
const schedule_service_1 = require("../services/schedule.service");
const elective_service_1 = require("../services/elective.service");
...
if (!enrollmentNo) {
    ...
    return;
            ...
            const availableCourses = courses.filter((course) => !registeredCodes.includes(course.course_code));
            // Format response
    ...
    static async registerCourse(req, res) {
        try {
            ...
            const prereqCheck = await (0, prerequisite_service_1.checkPrerequisites)(enrollmentNo, course_code);
            if (!prereqCheck.met) {
                res.status(400).json({
            ...
            const creditCheck = await (0, credit_service_1.validateCreditLimit)(enrollmentNo, course_code);
            ...
            const scheduleCheck = await (0, schedule_service_1.checkScheduleConflict)(enrollmentNo, course_code);
            ...
            const electiveCheck = await (0, elective_service_1.validateElectiveSelection)(enrollmentNo, course_code);
    ...
    static async getEnrolledCourses(req, res) {
        try {
            ...
            const totalCredits = await (0, credit_service_1.calculateCurrentCredits)(enrollmentNo);
